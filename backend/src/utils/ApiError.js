/**
 * Standard application error used across services/controllers.
 * Keeping this centralized lets the error middleware format all
 * failures consistently, instead of each controller writing its own res.status(...).
 */
